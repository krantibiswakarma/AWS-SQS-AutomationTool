...
public class CredentialProvider {
	...
	public AmazonSQS provideCredential() {
		BasicAWSCredentials awsCreds = new BasicAWSCredentials(getPropertyFromFile("authCode"), getPropertyFromFile("secretCode"));
    	final AmazonSQS sqs = AmazonSQSClientBuilder.standard().withRegion(getPropertyFromFile("region"))
